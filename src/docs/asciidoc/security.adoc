...
The NIST manages a list of FIPS certified cryptographic modules. Certified modules are validated under the Cryptographic Module Validation Program. The list can be searched online: https://csrc.nist.gov/projects/cryptographic-module-validation-program/validated-modules/search
